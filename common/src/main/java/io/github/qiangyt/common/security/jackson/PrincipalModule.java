...
public class PrincipalModule {
    ...
    public static class Serializer extends JacksonSerializer<Principal> {
        ...
        @Override
        protected void dump(Principal value, @Nonnull JsonGenerator gen) throws Exception {
    ...
    public static class Deserializer extends JacksonDeserializer<Principal> {
    ...
    public static SimpleModule build(boolean expandEnv, boolean dump) {
        ...
        r.addSerializer(Principal.class, new Serializer(dump));
        r.addDeserializer(Principal.class, new Deserializer(expandEnv));
        return r;
    }
